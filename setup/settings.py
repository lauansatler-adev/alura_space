...
SECRET_KEY = str(os.getenv('SECRET_KEY')) #Trazendo a variável de ambiente com o secret Key convertendo em String
...
# Variável global para referenciar o diretório "media"
MEDIA_URL = "/media/"
